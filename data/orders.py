...
order1 = Order(
    ...
    dine_in=[
        ...
        OrderItem(
            quantity=1,
            product="Bowl L - Carne, Chori",
            details="Queso, Curry, Ketchup, Burguer",
            extra=None,
            is_cooked=True,
        ),
        OrderItem(
...
order2 = Order(
    ...
    take_out=[
        ...
        OrderItem(
            quantity=1, product="Fanta 300ml", details=None, extra=None, is_cooked=False
        ),
    ],
)
